...
const UserDashboard = () => {
  ...
  const filteredTasks = {
  "To Do": tasks["To Do"].filter(task => 
    completionFilter === "all" || 
    (completionFilter === "complete" && task.progress > 80) || 
    (completionFilter === "incomplete" && task.progress <= 80)
  ),
  ...
  useEffect(() => {
    ...
    const categorizedTasks = {
      "To Do": storedTasks.filter((task) => task.progress <= 20),
      "In Progress": storedTasks.filter((task) => task.progress > 20 && task.progress <= 60),
      Completed: storedTasks.filter((task) => task.progress > 100),
    };
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-blue-100 to-gray-100">
      ...
      <div className="flex-1 p-6">
        ...
        <div className="mb-6">
          <label htmlFor="completion-filter" className="block font-semibold mb-2">Filter by Completion</label>
          <select
